...
static void SetWordsInterval(HWND hwnd, int sec) {
    WORD_SWITCH_INTERVAL_SEC = sec;
    if (WORD_SWITCH_INTERVAL_SEC < 0) WORD_SWITCH_INTERVAL_SEC = 0;
    char config_path[MAX_PATH];
    GetConfigPath(config_path, MAX_PATH);
    WriteConfig(config_path);
    InvalidateRect(hwnd, NULL, TRUE);
...
static LRESULT CmdWordsInterval(HWND hwnd, WPARAM wp, LPARAM lp) {
    ...
    switch (LOWORD(wp)) {
        ...
        case CLOCK_IDM_WORDS_INTERVAL_5S:   SetWordsInterval(hwnd, 5); break;
        case CLOCK_IDM_WORDS_INTERVAL_10S:  SetWordsInterval(hwnd, 10); break;
        case CLOCK_IDM_WORDS_INTERVAL_20S:  SetWordsInterval(hwnd, 20); break;
        case CLOCK_IDM_WORDS_INTERVAL_30S:  SetWordsInterval(hwnd, 30); break;
...
static const CommandDispatchEntry COMMAND_DISPATCH_TABLE[] = {
    ...
    /* Words */
    {CLOCK_IDM_WORDS_TOGGLE, CmdWordsToggle},
    {CLOCK_IDM_WORDS_NEXT, CmdWordsNext},
    {CLOCK_IDM_WORDS_INTERVAL_OFF, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_5S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_10S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_20S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_30S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_60S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_120S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_INTERVAL_300S, CmdWordsInterval},
    {CLOCK_IDM_WORDS_SHOW_PHONETIC, CmdWordsShowPhonetic},
    {CLOCK_IDM_WORDS_PHONETIC_UK, CmdWordsPhoneticMode},
    {CLOCK_IDM_WORDS_PHONETIC_US, CmdWordsPhoneticMode},
    {CLOCK_IDM_WORDS_PHONETIC_BOTH, CmdWordsPhoneticMode},
    {CLOCK_IDM_WORDS_SHOW_CHINESE, CmdWordsShowChinese},
    {CLOCK_IDM_WORDS_CN_LEN_0, CmdWordsChineseLen},
    {CLOCK_IDM_WORDS_CN_LEN_6, CmdWordsChineseLen},
    {CLOCK_IDM_WORDS_CN_LEN_10, CmdWordsChineseLen},
    {CLOCK_IDM_WORDS_CN_LEN_16, CmdWordsChineseLen},
