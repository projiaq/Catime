...
static const ConfigItemMeta CONFIG_METADATA[] = {
    ...
    /* Words */
    {INI_SECTION_WORDS, "ENABLED", "FALSE", CONFIG_TYPE_BOOL, CFG_OFFSET(wordsEnabled), CFG_NO_SIZE, "Enable built-in word display"},
    {INI_SECTION_WORDS, "SWITCH_INTERVAL_SEC", "20", CONFIG_TYPE_INT, CFG_OFFSET(wordsSwitchIntervalSec), CFG_NO_SIZE, "Auto switch interval (seconds), 0 disables"},
    {INI_SECTION_WORDS, "SHOW_PHONETIC", "TRUE", CONFIG_TYPE_BOOL, CFG_OFFSET(wordsShowPhonetic), CFG_NO_SIZE, "Show phonetic transcription"},
    {INI_SECTION_WORDS, "PHONETIC_MODE", "0", CONFIG_TYPE_INT, CFG_OFFSET(wordsPhoneticMode), CFG_NO_SIZE, "0=UK,1=US,2=BOTH"},
    {INI_SECTION_WORDS, "SHOW_CHINESE", "TRUE", CONFIG_TYPE_BOOL, CFG_OFFSET(wordsShowChinese), CFG_NO_SIZE, "Show Chinese translation (short)"},
    {INI_SECTION_WORDS, "CHINESE_MAX_LEN", "10", CONFIG_TYPE_INT, CFG_OFFSET(wordsChineseMaxLen), CFG_NO_SIZE, "Max Chinese chars (0=unlimited)"},
